...
import torch
from nnunet.network_architecture.generic_RKSegPlusIR import Generic_RKSegPlusIR, ConvDropoutNormNonlin
...
class RKSegPlusIRTrainerV2_noDeepSupervision(nnUNetTrainerV2_noDeepSupervision):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_RKSegPlusIR(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    seg_output_use_bias=False, type=self.RK_type)
...
class RKSegPlusIRTrainerV2_noDeepSupervision_150epochs(RKSegPlusIRTrainerV2_noDeepSupervision):
    """
